...
from demo_systems import CITED_PHASES

DEMO_CANDIDATES: List[Dict] = [
    {"material_id": "demo-FeAl", "formula": "FeAl", "composition": {"Fe": 1, "Al": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 152.0, "shear_modulus": 73.0, "source": "demo"},
    {"material_id": "demo-Fe3Al", "formula": "Fe3Al", "composition": {"Fe": 3, "Al": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 140.0, "shear_modulus": 68.0, "source": "demo"},
    {"material_id": "demo-Al13Fe4", "formula": "Al13Fe4", "composition": {"Al": 13, "Fe": 4}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 110.0, "shear_modulus": 55.0, "source": "demo"},
    ...
    {"material_id": "demo-Zn13Fe", "formula": "Zn13Fe", "composition": {"Zn": 13, "Fe": 1}, "e_above_hull": 0.02, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 80.0, "shear_modulus": 35.0, "source": "demo"},
    ...
    {"material_id": "demo-NiAl", "formula": "NiAl", "composition": {"Ni": 1, "Al": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 160.0, "shear_modulus": 80.0, "source": "demo"},
    {"material_id": "demo-CoAl", "formula": "CoAl", "composition": {"Co": 1, "Al": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 165.0, "shear_modulus": 85.0, "source": "demo"},
    ...
    {"material_id": "demo-FeTi", "formula": "FeTi", "composition": {"Fe": 1, "Ti": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 160.0, "shear_modulus": 70.0, "source": "demo"},
    {"material_id": "demo-NiGa", "formula": "NiGa", "composition": {"Ni": 1, "Ga": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 140.0, "shear_modulus": 55.0, "source": "demo"},
    {"material_id": "demo-Ni3Ga", "formula": "Ni3Ga", "composition": {"Ni": 3, "Ga": 1}, "e_above_hull": 0.0, "theoretical": False, "has_icsd": True, "flagged_gnome": False, "bulk_modulus": 170.0, "shear_modulus": 80.0, "source": "demo"},
...
def load_cited():
    wanted = set(CITED_PHASES)
    return [dict(r) for r in DEMO_CANDIDATES if r.get("formula") in wanted]

def load_demo(elements, exact_chemsys=True):
